...
export default class CMenu {
    ...
    constructor(
        ...
        // @ts-ignore
        this.stickersType =
			(stickersType && (Array.isArray(stickersType) ? stickersType : [stickersType])) ||
			(typeof handler !== 'function' && Array.isArray(handler) ? handler : []);
    }
     ...
     * isHere
     */
    public isHere(context: MessageContext): boolean {
